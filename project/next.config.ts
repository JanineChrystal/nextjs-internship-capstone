...
const securityHeaders = [
	...
	},
	{
		...
		value:
			"default-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' https://img.clerk.com https://images.clerk.dev data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clerk.accounts.dev https://*.clerk.com; connect-src 'self' https://*.clerk.accounts.dev https://*.clerk.com; worker-src 'self' blob:;",
	},
];
